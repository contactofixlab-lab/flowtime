    ...
    <>
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "24px 16px 0" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <div>
            <h1 style={{ color: "#F1F5F9", fontSize: 22, fontWeight: 800, margin: 0, letterSpacing: "-0.02em" }}>Mis Tareas</h1>
            {pending > 0 && (
              <p style={{ color: "#475569", fontSize: 12, margin: "2px 0 0" }}>{pending} pendiente{pending !== 1 ? "s" : ""}</p>
            )}
          </div>
          <button
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16, overflowX: "auto", paddingBottom: 4 }}>
          {FILTERS.map(f => (
            <button
              ...
              style={{
                whiteSpace: "nowrap", padding: "7px 14px", borderRadius: 20, fontSize: 12, fontWeight: 600,
        ...
        {filtered.length === 0 ? (
          <div style={{ ...card, padding: "48px 20px", textAlign: "center" }}>
            ...
            <p style={{ color: "#475569", fontSize: 14, margin: 0 }}>No hay tareas aquí</p>
            <button
              onClick={() => setShowModal(true)}
              style={{
                marginTop: 16, padding: "10px 20px", borderRadius: 12, fontSize: 13, fontWeight: 700,
            ...
            {filtered.map(task => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  {task.description && (
                    <p style={{ color: "#475569", fontSize: 12, margin: "0 0 6px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {task.description}
                    </p>
                  )}
                ...
                <button
                  ...
                  style={{
                    ...
                    color: "#334155", padding: 4, fontSize: 16, lineHeight: 1,
                  }}
                >🗑</button>
              </div>
            ))}
